* OKay, this is my fork of emacs.d
yep, it's originally from redguard2's emacs.d.
...
Dictionnaries with ".pyim" extension under  =~/.eim/= are automatically loaded.

You can =M-x my-pyim-export-dictionary= to export to personal dictionary.
